        ...
        <div className="space-y-6">
              ...
              <ul className="space-y-4">
                <li className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Basic building blocks: buttons, inputs, labels, etc. These
                    are atomic components with minimal dependencies.
                  </p>
                </li>
                <li className="space-y-2">
                  <h3 className="flex items-center gap-2 font-semibold">
                    Components{" "}
                    <Badge variant="outline">src/ui/components/</Badge>
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    Complex components built from elements: forms, charts,
                    tables, etc. These combine multiple elements and logic.
                  </p>
                </li>
                <li className="space-y-2">
                  <h3 className="flex items-center gap-2 font-semibold">
                    Experimental{" "}
                    <Badge variant="outline">src/ui/experimental/</Badge>
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    Early development components that need additional testing
                    for utility and bug identification.
                  </p>
                </li>
                <li className="space-y-2">
                  <h3 className="flex items-center gap-2 font-semibold">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Structural organization components: grid, stack, box, etc.
                    These are used to layout other components.
                  </p>
                </li>
              </ul>
            </CardContent>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Use Tailwind CSS utility classes for consistent,
                    maintainable styling. Avoid custom CSS when possible.
                  </p>
                </div>
                <div>
                  <h4 className="font-medium">Composable Design</h4>
                  <p className="text-sm text-muted-foreground">
                    Build components from smaller, reusable pieces. Use variants
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Use TypeScript for all components. Leverage variant props
                    and proper typing for better developer experience.
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Standard pattern for component implementation
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div>
                  <h4 className="mb-2 font-medium">Basic Structure</h4>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <h4 className="mb-2 font-medium">File Location</h4>
                <p className="mb-3 text-sm text-muted-foreground">
                  Create documentation in{" "}
                  <code className="rounded bg-muted px-1">
                    src/docs/routes/
                  </code>{" "}
                  following the component's location:
                </p>
                <ul className="ml-4 space-y-1 text-sm text-muted-foreground">
                  <li>
                    • Elements:{" "}
                    <code className="rounded bg-muted px-1">
                      src/docs/routes/elements/
                    </code>
                  </li>
                  <li>
                    • Components:{" "}
                    <code className="rounded bg-muted px-1">
                      src/docs/routes/components/
                    </code>
                  </li>
                  <li>
                    • Experimental:{" "}
                    <code className="rounded bg-muted px-1">
                      src/docs/routes/experimental/
                    </code>
                  </li>
                </ul>
              </div>
            ...
            <CardContent>
              <ol className="list-inside list-decimal space-y-2 text-sm">
                <li>
                  ...
                  <code className="rounded bg-muted px-1">src/ui/</code>{" "}
                  subdirectory
                </li>
                <li>
                  Implement component following the structure pattern above
                </li>
                <li>
                  Create documentation file in corresponding{" "}
                  <code className="rounded bg-muted px-1">
                    src/docs/routes/
                  </code>{" "}
                  directory
                ...
                <li>
                  Add route to{" "}
                  <code className="rounded bg-muted px-1">
                    src/docs/components/app-sidebar.tsx
                  </code>
                </li>
            ...
            <CardContent>
              <div className="space-y-2 text-sm">
                ...
                <p className="text-muted-foreground">
                  See{" "}
                  <code className="rounded bg-muted px-1">
                    src/docs/routes/elements/button.tsx
                  </code>{" "}
