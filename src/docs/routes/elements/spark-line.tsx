    ...
    <div className="grid gap-6 md:grid-cols-2">
      <div className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="default" className="bg-green-100 text-green-800">
                <MoveUpRight className="h-4 w-4" /> Increasing
              </Badge>
            </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="destructive" className="bg-red-100 text-red-800">
                <MoveDownRight className="h-4 w-4" /> Decreasing
              </Badge>
            </div>
        ...
        <p className="text-sm text-muted-foreground">
          All sparklines use the primary color regardless of data trend
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground">
          Sparklines change color based on data trend (green for increasing, red
          for decreasing)
        </p>
      </div>
    </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Use CSS variables, hex colors, or let trend indication choose
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Compare default primary color behavior with trend-based coloring
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DemoContainer
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Different sparkline sizes for various use cases
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DemoContainer
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Customizable sparklines with different stroke widths and trend
                indication control
              </CardDescription>
            </CardHeader>
