      ...
      <div className="flex items-start space-x-2">
        ...
        <div className="grid gap-1.5 leading-none">
          ...
          <p className="text-xs text-muted-foreground">
            Automatically adjust sample height for optimal focus
          </p>
        </div>
      </div>
      <div className="flex items-start space-x-2">
        ...
        <div className="grid gap-1.5 leading-none">
          ...
          <p className="text-xs text-muted-foreground">
            Stream data to backup storage during collection
          </p>
        </div>
      </div>
    </div>
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Simple toggle switches for synchrotron system controls
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DemoContainer
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Different switch states and interactions
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DemoContainer
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Switches with additional context and descriptions
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DemoContainer
