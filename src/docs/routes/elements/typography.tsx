...
function TextVariantsDemo() {
  return (
    <div className="space-y-4">
      <TypographyLead>
        Welcome to the Advanced Photon Source beamline 24-ID-C. This facility
        provides high-brightness X-rays for macromolecular crystallography
        studies.
      </TypographyLead>

      <TypographyP>
        The beamline operates at energies ranging from 6.5 to 24 keV, with a
        flux of up to 10¹² photons/second. Our Pilatus 6M detector provides
        rapid data collection with minimal readout time.
      </TypographyP>
      ...
      <TypographySmall>
        Sample temperature: 100K | Wavelength: 0.9792 Å | Detector distance:
        400mm
      </TypographySmall>
  ...
  return (
    <div className="space-y-4">
      ...
      <TypographyBlockquote>
        ...
        <TypographySmall color="muted" className="mt-2 block">
      ...
      <TypographyP>
        Key parameters:{" "}
        <TypographyInlineCode>exposure_time = 0.5s</TypographyInlineCode>,
...
function VariantVsShortcutDemo() {
  return (
    <div className="space-y-6">
      <div>
        <TypographyH3 color="primary" className="mb-3">
          Using Variant Prop
        </TypographyH3>
      ...
      <div>
        ...
        <Typography variant="h3" color="success">
          Experiment Status (variant="h3")
        </Typography>
        <TypographyP>
          Data collection progress:{" "}
          <TypographyInlineCode>75% complete</TypographyInlineCode>
        </TypographyP>
        <Typography variant="blockquote" color="warning">
          "Sample temperature stability is critical for high-resolution data
          collection."
        </Typography>
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Hierarchical heading components for document structure
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DemoContainer demo={<HeadingsDemo />} source={headingsSource} />
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Typography with custom alignment, colors, and spacing
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DemoContainer
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Compare using the variant prop versus dedicated component
                shortcuts
              </CardDescription>
            </CardHeader>
            <CardContent>
