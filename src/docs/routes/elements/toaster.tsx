...
function BasicToasterDemo() {
  return (
    <div className="flex flex-wrap gap-4">
      <Button
        onClick={() =>
          toast.success("Beamline 7-ID successfully initialised", {
      ...
      <Button
        onClick={() =>
          toast.error("Detector temperature exceeded limits", {
      ...
      <Button
        onClick={() =>
          toast.warning("Beam intensity fluctuating", {
      ...
      <Button
        onClick={() =>
          toast.info("Sample stage moving to position (150, 300)", {
            icon: (
              <div className="flex h-5 w-5 animate-pulse items-center justify-center rounded-full bg-primary/20">
...
function ToasterWithActionsDemo() {
  return (
    <div className="flex flex-wrap gap-4">
      <Button
        onClick={() =>
          toast("Data collection complete", {
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Different types of toast notifications for synchrotron
                operations
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Interactive toasts with actions and promise handling
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DemoContainer
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Additional toast options and configurations
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DemoContainer
