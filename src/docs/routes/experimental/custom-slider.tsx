...
import { CustomSlider as Slider } from '../../../ui/experimental/custom-slider';
import { Label } from '../../../ui/elements/label';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '../../../ui/layout/card';
import { DemoContainer } from '@/docs/components/demo-container';

export const Route = createFileRoute('/experimental/custom-slider')({
    ...
    return (
        <>
            <PageHeader
                ...
                pageHeading="Slider"
                pageSubheading="Styled sci comp UI slider. Not sure if people are using the current default exported one, so I've created this as a separate component for now, instead of replacing the existing one, until we confirm whether people are using the old default one."
            />
            <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
                <div className="space-y-6">
                    <Card>
                        ...
                        <CardContent>
                            <DemoContainer demo={<BasicSliderDemo />} source={basicSliderSource} />
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <DemoContainer demo={<RangeSliderDemo />} source={rangeSliderSource} />
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <DemoContainer demo={<SliderStatesDemo />} source={sliderStatesSource} />
                        </CardContent>
                    </Card>
                </div>
            </div>
