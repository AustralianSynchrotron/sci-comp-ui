  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Overlapping histograms comparing two different groups
        </CardDescription>
      </CardHeader>
      <CardContent>
        <HistogramChart
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Horizontal histogram showing price distribution
        </CardDescription>
      </CardHeader>
      <CardContent>
        <HistogramChart
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Overlapping histograms for comparing multiple datasets
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DemoContainer
          ...
          <Card>
            <CardHeader>
              <CardTitle>Horizontal Orientation</CardTitle>
              <CardDescription>
                Histogram with horizontal bar layout
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DemoContainer
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Minimal histogram for dashboard widgets; you can also lock the
                zoom and hide the mode bar
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DemoContainer
