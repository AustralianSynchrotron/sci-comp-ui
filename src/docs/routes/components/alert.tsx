  ...
  return (
    <div className="space-y-4">
      ...
      <Alert>
        ...
        <AlertDescription>
          Detector calibration has been completed successfully. Resolution: 0.1°
          ± 0.02° from reference position.
        </AlertDescription>
      </Alert>
    </div>
  );
  ...
  return (
    <div className="space-y-4">
      <Alert variant="destructive">
        ...
        <AlertDescription>
          Beamline temperature has exceeded safe operating limits. Current: 85°C
          (Max: 80°C). Immediate intervention required.
        </AlertDescription>
      </Alert>
      ...
      <Alert variant="destructive">
        ...
        <AlertDescription>
          Interlock system has detected an unauthorised access attempt. Beam has
          been automatically shut down. Contact safety officer immediately.
        </AlertDescription>
      </Alert>
    </div>
  );
    ...
    <div className="space-y-4">
      <Alert className="border-blue-200 bg-blue-50">
        ...
        <AlertDescription className="text-blue-700">
          Data collection at 45% completion. Estimated time remaining: 2 hours
          15 minutes. Current sample: Protein crystal (PDB: 1ABC) at 100K.
        </AlertDescription>
      </Alert>
      ...
      <Alert className="border-amber-200 bg-amber-50">
        ...
        <AlertDescription className="text-amber-700">
          Scheduled maintenance for goniometer system in 3 days. Please complete
          all experiments by end of shift.
        </AlertDescription>
      </Alert>
    </div>
  );
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Standard alert messages with icons and descriptions
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DemoContainer
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Alerts for critical warnings and error conditions
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DemoContainer
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Alerts with custom colors and styling for different contexts
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DemoContainer
