  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Product sales comparison across four quarters
        </CardDescription>
      </CardHeader>
      <CardContent>
        <BarChart data={barData} orientation="vertical" height={400} />
      </CardContent>
    </Card>
  );
}
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Multi-dimensional performance analysis across different teams
        </CardDescription>
      </CardHeader>
      <CardContent>
        <BarChart data={multiMetricData} orientation="vertical" height={400} />
      </CardContent>
    </Card>
  );
}
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Standard vertical bar chart with multiple data series
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DemoContainer
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Bar chart with horizontal layout for better label readability
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DemoContainer
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Minimal bar chart for dashboard widgets and space-constrained
                areas
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Compare multiple metrics across different categories
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DemoContainer
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Same data displayed in both vertical and horizontal orientations
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DemoContainer
