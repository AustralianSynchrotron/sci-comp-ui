...
function CameraControl({ className, cameraSource, cursorPosition, onMousePositionChange, onClick, showIntensity = false }: CameraControlProps & { cursorPosition?: { x: number, y: number } | null }) {
    ...
    // DRY: Get mouse position and intensity
